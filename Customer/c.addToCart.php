...
<h1 style="font-size: 35px; font-weight: bold; color: #7a2005; margin-top: 20px;">Atur Pesananmu!</h1>
...
<form action="c_addToCart.php" method="post">
    ...
    <select id="milk" name="milk">
        <option value="Oat Milk">Oat Milk + Rp. 1.00</option>
        <option value="Dairy Milk">Dairy Milk</option>
        <option value="Full Cream Milk">Full Cream Milk + Rp. 0.75</option>
        <option value="Low Fat Milk">Low Fat Milk + Rp. 0.50</option>
        <option value="Coconut Milk">Coconut Milk + Rp. 1.25</option>
    </select>
    ...
    <select id="temperature" name="temperature">
        ...
        <option value="Cold">Cold + Rp. 0.50</option>
    </select>

    <label for="size">Select Size:</label>
    <select id="size" name="size">
        <option value="Regular">Regular</option>
        <option value="Large">Large + Rp. 1.50</option>
    </select>

    <label for="cream">Whipped Cream Preference:</label>
    <select id="cream" name="cream">
        <option value="Yes">Yes + Rp. 1.00</option>
    ...
    <select id="bean" name="bean">
        ...
        <option value="Geisha">Geisha + Rp. 2.00</option>
        <option value="Arabica">Arabica + Rp. 0.50</option>
        <option value="Typica">Typica + Rp. 0.75</option>
        <option value="Robusta">Robusta + Rp. 0.50</option>
        <option value="Liberica">Liberica + Rp. 1.25</option>
        <option value="Excelsa">Excelsa + Rp. 1.00</option>
    </select>
