    ...
    <div class="grid grid-cols-2 gap-6">
      ...
      <div class="bg-pink-50 p-4 rounded-lg">
        ...
        <div class="space-y-2">
          ...
          <p><span class="font-medium">Total:</span> Rp. 20.000</p>
        </div>
      </div>
      ...
      <div class="bg-pink-50 p-4 rounded-lg">
        ...
        <div class="space-y-2">
          <p><span class="font-medium">Name:</span> Miftah</p>
          <p><span class="font-medium">Email:</span> miftah@gmail.com</p>
      ...
      <div class="scrollable-box">
        <div class="space-y-4">
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            ...
            <p class="text-pink-700">Rp. 12.000</p>
          </div>
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            <div>
            ...
            <p class="text-pink-700">Rp. 8.000</p>
          </div>
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            <div>
            ...
            <p class="text-pink-700">Rp. 15.000</p>
          </div>
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            <div>
            ...
            <p class="text-pink-700">Rp. 10.000</p>
          </div>
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            <div>
            ...
            <p class="text-pink-700">Rp. 14.000</p>
          </div>
          <div class="flex justify-between items-center p-4 bg-pink-50 rounded-lg">
            <div>
            ...
            <p class="text-pink-700">Rp. 9.000</p>
          </div>
        </div>
      </div>
    </div>
