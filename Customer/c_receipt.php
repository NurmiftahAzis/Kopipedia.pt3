...
<div class="container">
        ...
        <tbody>
            <?php foreach ($_SESSION['cart'] as $index => $item): ?>
                <tr>
                    ...
                    <td>Rp. <?php echo number_format($item['price'] * ($item['quantity'] ?? 1), 2); ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
    ...
    <div class="total-details">
        <p><strong>Sub Total:</strong> Rp. <?php echo number_format($total - $deliveryFee, 2); ?></p>
        <?php if ($orderMethod === 'delivery'): ?>
            <p><strong>Delivery Charges:</strong> Rp. <?php echo number_format($deliveryFee, 2); ?></p>
        <?php endif; ?>
        <p><strong>Total:</strong> Rp. <?php echo number_format($finalTotal, 2); ?></p>
    </div>

    <div class="footer">
        <p>333 44 234</p>
        <p>www.KopiPedia.com</p>
        <p>cs@KopiPedia.com</p>
    </div>
